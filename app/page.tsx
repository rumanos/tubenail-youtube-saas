...
const features = [
  ...
  },
  {
    ...
    description: 
      "Engage in deep conversations about your content strategy, brainstorm ideas, and unlock new creative possibilities with your AI agent companionl",
    icon: Sparkles,
    ...
    <div className='min-h-screen'>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-zinc-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center gap-10 text-center m-12">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white p-6 rounded-xl border border-zinc-200 hover:border-blue-500 transition-all duration-300">
