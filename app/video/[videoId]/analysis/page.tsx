...
function AnalysisPage() {
  ...
  const VideoTranscriptionStatus =
    video === undefined ? (
      <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-50 border border-zinc-200 rounded-full">
  ...
  return (
    <div className="xl:container mx-auto px-4 md:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* Left side */}
        <div className="order-2 lg:order-1 flex flex-col gap-4 bg-white lg:border-r border-zinc-200 p-6">
          {/* Analysis Section */}
          <div className="flex flex-col gap-4 p-4 border border-zinc-200 rounded-xl">
            <Usage
